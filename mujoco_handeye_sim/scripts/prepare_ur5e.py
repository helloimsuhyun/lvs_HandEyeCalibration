#!/usr/bin/env python3
"""Flatten the installed official UR5e xacro for the MuJoCo builder."""
...
def main() -> int:
    ...
    output = root / "build" / "ur5e_ljv7080" / "ur5e_robot.urdf"
    output.parent.mkdir(parents=True, exist_ok=True)

    xacro = shutil.which("xacro")
    if not xacro:
        raise SystemExit(
            "xacro not found. Run: source /opt/ros/humble/setup.bash and install ros-humble-ur."
        )
